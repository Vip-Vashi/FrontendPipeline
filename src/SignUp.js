...
function SignUp() {
    ...
    const[inputdata, setInputdata] = useState({
      ...
      let handleSubmit=(e)=>{
        ...
        if(result === true){
         axios 
         .post("http://localhost:1000/registration", inputdata)
         .then((res) => {
      ...
      const validateValues = (inputdata) => {
        if (inputdata.email  === 0) {
          alert("Email Cannot be empty value!!!");
          return false;
        }
        if (inputdata.password.length === 0 || inputdata.password.length<8) {
            alert("Password  Cannot be empty value !!  It Should Contain atleast 8 characters!!!");
            return false;
          }
         else {
          return true;
                ...
                <div className="w-full max-w-md space-y-8 px-4 bg-white text-gray-600 sm:px-0">
                    <div className="">
                        ...
                        <div className="mt-5 space-y-2">
                            <h3 className="text-gray-800 text-2xl font-bold sm:text-3xl" role="title">Sign up</h3>
                    ...
                    >
                        <div>
                            <label className="font-medium" for="uname" >
                                Name
                            </label>
                            <input
                                type="text"
