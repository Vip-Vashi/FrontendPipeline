...
function Add() {
  ...
  const validateValues = (inputdata) => {
    if (inputdata.uname.length === 0) {
      alert("Please enter Name !!! Please Enter the Valid Inputs!!!");
      return false;
    } else if (inputdata.age< 18) {
      alert("Minimum Age is 18 !!! Please Enter the Valid Inputs!!!");
      return false;
    } else if (inputdata.addr.length === 0) {
      alert("Please enter City Name !!! Please Enter the Valid Inputs!!!");
      return false;
    }
    else if (inputdata.sal === 0) {
      alert("Salary should be Greater than 0 !!! Please Enter the Valid Inputs!!!");
      return false;
    }
    else if (inputdata.religion.length === 0) {
      alert("Please enter Religion  Name !!! Please Enter the Valid Inputs!!!");
      return false;
    } else {
      return true;
    }
    ...
    >
      <div className="w-50 border bg-light p-5">
        ...
        <select id="selectId" onChange={handleChange}>
          ...
          <button className="btn btn-info " id='submit' role='submitbutton'>Submit</button>
        </form>
