    ...
    <div class="bg-white text-black text-[15px]">
      <header
        ...
        <div class='flex flex-wrap items-center gap-4'>
          <a href="/"><img src="https://dcassetcdn.com/design_img/2719096/517402/517402_14793578_2719096_4d2367b0_image.jpg" alt="logo" class='w-40' />
          </a>
          ...
          <div id="collapseMenu"
            ...
            <ul
              ...
              <li class='max-lg:border-b max-lg:py-3 px-3'><a href='javascript:void(0)'
                  class='hover:text-blue-600 block font-semibold transition-all'>Our Teams</a>
              </li>
              <li class='max-lg:border-b max-lg:py-3 px-3'><a href='/landing'
                  class='hover:text-blue-600 block font-semibold transition-all'>Features</a>
              </li>
              <li class='max-lg:border-b max-lg:py-3 px-3'><a href='javascript:void(0)'
          ...
          <div class='flex ml-auto'>
            <button class='mr-6 font-semibold border-none outline-none'><a href="/signup"
                class='text-blue-600 hover:underline'>SignUp</a></button>
            <button class='bg-blue-600 hover:bg-blue-700 transition-all text-white rounded-full px-5 py-2.5'><a href='/login'>Login</a>
            </button>
      ...
      <div class="px-4 sm:px-10">
          ...
          <div class="grid md:grid-cols-2 justify-center items-center gap-10">
            <div class="max-md:order-1">
              <p class="mt-4 mb-2 font-semibold text-blue-600"><span class="rotate-90 inline-block mr-2">|</span> ALL IN
                ONE
                Wedding Planner</p>
              <h1 class="md:text-5xl text-4xl font-bold mb-4 md:!leading-[55px]">Select Your Perfect Partner</h1>
              <p class="mt-4 text-base leading-relaxed">The best time to love with your whole heart is always now, in this moment, because no breath beyond the current is promised.” “To find someone who will love you for no reason, and to shower that person with reasons, that is the ultimate happiness.</p>
              <div
          ...
          <div class="max-w-7xl mx-auto">
            ...
            <div class="grid lg:grid-cols-3 sm:grid-cols-2 gap-10 mt-14">
              <div>
                ...
                <p>Choose the pair made for you.</p>
          ...
          <div class="max-w-7xl max-md:max-w-lg mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-14">
              <div class="bg-white cursor-pointer rounded-md overflow-hidden group">
                ...
                <div class="p-6">
                  <h3 class="text-xl font-semibold">Express your Desires</h3>
                  <button type="button"
              ...
              <div class="bg-white cursor-pointer rounded-md overflow-hidden group">
                ...
                <div class="p-6">
                  <h3 class="text-xl font-semibold">Desigs and Trends for Occassions</h3>
                  <button type="button"
                    class="bg-blue-600 hover:bg-blue-700 text-white rounded-full px-5 py-2.5 mt-6 transition-all">Read
                    More</button>
                </div>
        ...
        <div class="mt-28 bg-gray-50 px-4 sm:px-10 py-12 space-y-6">
          ...
          <div
            ...
            role="accordion">
            <button type="button" class="w-full font-semibold text-left py-5 px-6 flex items-center">
              <span class="text-base mr-4">What are locations available?</span>
          ...
          <div
            ...
            role="accordion">
            <button type="button" class="w-full font-semibold text-left py-5 px-6 flex items-center">
              <span class="text-base mr-4">What are the plans available and their Costs?</span>
              <svg xmlns="http://www.w3.org/2000/svg" class="w-4 fill-current ml-auto shrink-0 -rotate-90"
                viewBox="0 0 24 24">
                <path fill-rule="evenodd"
                  d="M11.99997 18.1669a2.38 2.38 0 0 1-1.68266-.69733l-9.52-9.52a2.38 2.38 0 1 1 3.36532-3.36532l7.83734 7.83734 7.83734-7.83734a2.38 2.38 0 1 1 3.36532 3.36532l-9.52 9.52a2.38 2.38 0 0 1-1.68266.69734z"
      ...
      <footer class="bg-gray-50 px-4 sm:px-10 py-12 mt-28">
        ...
        <div class="grid max-sm:grid-cols-1 max-xl:grid-cols-2 xl:grid-cols-5 gap-8 border-t border-gray-300 mt-10 pt-8">
          ...
          <div>
            ...
            <ul class="space-y-4">
              <li><a href="javascript:void(0)" class="hover:text-blue-600">Grooming 
                  </a></li>
              <li><a href="javascript:void(0)" class="hover:text-blue-600">Wedding Arangements
                  </a></li>
              <li><a href="javascript:void(0)" class="hover:text-blue-600">Profile Matching
                  Design</a></li>
          ...
          <div>
            ...
            <ul class="space-y-4">
              <li><a href="javascript:void(0)" class="hover:text-blue-600">MatchMakers</a>
              </li>
              <li><a href="javascript:void(0)" class="hover:text-blue-600">Eprofiles</a>
              </li>
              <li><a href="javascript:void(0)" class="hover:text-blue-600">Templates</a>
              </li>
              <li><a href="javascript:void(0)" class="hover:text-blue-600">OnlineMeetings</a></li>
            </ul>
          </div>
          <div>
        ...
        <p class='mt-10'>© 2023<a href='https://readymadeui.com/' target='_blank'
            class="hover:underline mx-1">PerfectYourMarriage</a>All Rights Reserved.</p>
      </footer>
