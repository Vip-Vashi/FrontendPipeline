...
function Contact() {
  return (
      ...
      <div class="font-[sans-serif] max-w-9xl mx-auto relative bg-gray-800 lg py-6">
      <div class="grid lg:grid-cols-3 items-center">
        ...
        <div class="lg:col-span-2 max-w-3xl bg-gray-500 rounded-lg sm:p-10 p-4 z-10 max-lg:-order-1 max-lg:mb-8">
