...
function Product() {
  return (
    <div>
      <div class="font-sans py-4 mx-auto lg:max-w-9xl md:max-w-8xl max-sm:max-w-md bg-gray-800 ">
    ...
    <div class="font-[sans-serif] p-2 mx-auto lg:max-w-9xl md:max-w-8xl max-sm:max-w-md bg-gray-800">
